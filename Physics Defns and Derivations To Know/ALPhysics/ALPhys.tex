...
\begin{itemize}
    ...
    \item An \emph{\textcolor{pink!75!red}{iso-volumetric/isochoric} process} is one that takes place without a chance in volume, i.e. \(\Delta V=0\). Hence, when the external pressure is constant, \(W=0\).  

...
\begin{example}{spring systems are not \emph{always} in simple harmonic motion.}{}
    ...
    \end{figure}
    Then, the net force on the spring-mass system is \(W-F_{\text{spring}}=mg-kx\). Hence, the acceleration of the spring-mass system is \((mg/x)-k\not\propto x\). i.e. the system does not move in simple harmonic motion.
\end{example}
...
\begin{itemize}
    ...
    \item \emph{Polarisation} of a wave refers to the \emph{confinement} of oscillations in \emph{only} one plane. The plane of oscillations is \emph{parallel} to the direction of energy transfer, such that the direction of oscillation is normal to the direction of energy transfer.  
\begin{example}{}{}
...
\begin{example}{}{}
    ...
    \end{figure}
    \begin{itemize}
        \item When the switch is closed for a short time, the circuit is closed and current flows through the primary coil. This causes the magnetic flux density in the primary coil to increase. \hspace*{\fill} [1]
        \item The magnetic field is directed through the secondary coil by the iron core. \hspace*{\fill} [1]
...
\begin{longtable}{m{0.25\textwidth}m{0.75\textwidth}}
    ...
    \begin{itemize}
        \item When incident electrons pass by the charged nuclei of the high atomic mass lead atoms, the strong electric forces lead to a sudden deceleration of the electrons.
...
\begin{itemize}
    ...
    \item In any given set of repeated readings for time, the total time taken (e.g. for \(n\) oscillations) should not usually differ by more than human reaction time (\(0.2-0.4\)s).

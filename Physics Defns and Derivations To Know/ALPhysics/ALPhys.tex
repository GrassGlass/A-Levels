...
\begin{itemize}
    ...
    \[\text{the turns ratio}\coloneq\frac{N_S}{N_P}=\frac{V_S}{V_P}=\frac{I_S}{I_P}.\]
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item\label{Full-Wave-Rectification-Graph} Graph for a full-wave rectification \url{https://www.desmos.com/calculator/hwj30bli4o}
\end{enumerate}
\end{document}
...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Pressure antinode = Displacement node
    \end{enumerate}
    ...
    \begin{center} \hypertarget{StationaryWavesPhase}{}
        \includegraphics[scale=0.15]{../images/StationaryWavesPhase.jpg}
        \captionof{figure}{Phases in Stationary Waves}
    \end{center}
    \resizebox{\columnwidth}{!}{\begin{tabular}{|Sc|Sc|Sc|Sc|Sc|Sc|}
        \hline
    ...
    \begin{tabular}{|Sc|Sc|Sc|}
        ...
        \hline
    \end{tabular}
    \item Double-slits: For\footnote{Typical values: \(a \approx 0.5\)mm, \(D \approx 1\)m, and \(\lambda \approx 600\)nm. In any case, using the equation requires \(a<<D\).} a slit separation \(a\) and slit-screen distance \(D\), the fringe separation
    \[x=\frac{\lambda D}{a}.\]

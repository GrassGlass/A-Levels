...
\begin{itemize}
    ...
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../Current-Carrying-Wire/Current-Carrying-Wire.pdf}
    \end{center}
    \item Crosses \(\times\) represents the direction of going ``into the page'', and dots \(\times\) represents going ``out of the page''.
    \item Left and right hand rules:
    \begin{center}
        \includegraphics[width=0.4\textwidth]{../Left-Right-Hand-Rules/Left-hand-rule.pdf}
        \hspace{2cm}
        \includegraphics[width=0.28\textwidth]{../Left-Right-Hand-Rules/Right-hand-rule.pdf}
    \end{center}
    ...
    \[B=\frac{\mu_0NI}{2r}.\]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../Flat-Circular-Coil/Flat-Circular-Coil.pdf}
    \end{center}
    ...
    \begin{center}
        \begin{tabular}{|Sc|Sc|}
            ...
            \hline
        \end{tabular} 
        \includegraphics[scale=1.5,page=1]{../Two-Current-Carrying-Wires/Two-Current-Carrying-Wires.pdf}

        \includegraphics[scale=1.5,page=2]{../Two-Current-Carrying-Wires/Two-Current-Carrying-Wires.pdf}
    \end{center}

...
\begin{itemize}
    ...
    \begin{example}{}{}
        ...
        \begin{itemize}
            ...
            \item an external force that brings a (small test) mass from infinity to a finite distance \(x\) from \(M\) is \emph{opposite in direction} to the displacement of the mass. So, \emph{negative work} is done by the external force. \hspace*{\fill} [1]   

...
\begin{itemize}
    ...
    \begin{example}{}{}
        ...
        \begin{itemize}
            \item Since the emission line spectrum of an atom comprises of discrete lines, where each line corresponds to a specific wavelength \(\lambda\), the energies of photons \(E\propto 1/\lambda\) emitted are discrete. \hspace*{\fill} [1]

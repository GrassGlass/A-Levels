...
\begin{itemize}
    ...
    \item The below table provides a quick shortcut, that is particularly helpful in solving multiple choice questions fast. We assume a mass \(m_1\) is moving with velocity \(u_1\) towards a \emph{stationary} (\(u_2=0\)) mass \(m_2\).
    \begin{table}[H]
        \centering
...
\begin{figure}[H]
    ...
    \begin{subfigure}[c]{0.5\textwidth}
        ...
        \caption{After an elastic collision, the masses may travel in the same direction, with equal velocities.}
    \end{subfigure}%
    ...
    \begin{subfigure}[c]{\textwidth}
        ...
        \caption{After a perfectly inelastic collision, the coalesced masses travel together in the same direction.}
    \end{subfigure}%

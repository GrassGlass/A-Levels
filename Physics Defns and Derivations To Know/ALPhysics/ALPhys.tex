...
\begin{itemize}
    ...
    \item \emph{Internal energy} of a system is a sum of \emph{random distribution} of kinetic and potential energies \emph{associated with the molecules} of the system.
    ...
    \item An \emph{\textcolor{blue}{isothermal} process} is one that takes place without a change in temperature, i.e. \(\Delta T=0\). Thus, for an ideal gas (possibly non-monoatomic), \(\Delta U=\frac{3}{2}Nk\Delta T=0\).
...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \resizebox{\textwidth}{!}{\begin{tabular}{|Sc|Sc|Sc|Sc|Sc|Sc|}
            ...
            \hline
        \end{tabular}}
        \caption{The possible wavelengths and frequency of stationary waves in a string/pipe of fixed length \(L\), and which overtone/harmonic they correspond to. The \(m\)th harmonic is the number of half wavelengths formed in the string/pipe.}
        \label{<label>}
    \end{table}
    \begin{minipage}{0.3\textwidth}
        \begin{center}

...
\begin{itemize}
    ...
    \begin{center} \hypertarget{StationaryWavesPhase}{}
        ...
        \captionsetup{type=figure}
        \captionof{figure}{\ref{Phases in Stationary Waves} Phases in stationary waves}
    \end{center}
...
\begin{itemize}
    ...
    \[E=B\pi r^2f.\]
    \begin{center}
        \includegraphics[width=0.5\textwidth]{../images/Faraday’s-Paradox.png}
        \captionsetup{type=figure}
        \caption[figure]{\ref{Faraday's Paradox} An illustration of Faraday's Paradox.}
    \end{center}
\end{itemize}
...
\begin{itemize}
    ...
    \end{enumerate}
    \item Note that for a \emph{full wave sinusoidal} alternating current, 
    \[\langle P \rangle=\frac{1}{2}P_0.\]
    \begin{center}
        \includegraphics[width=\textwidth-25pt]{../images/Transformer/TransformerCropped.pdf}
...
\begin{enumerate}[label={[\arabic*]}]
    ...
    \item\label{Phases in Stationary Waves} Phases in Stationary waves (Made by me, Grass, in my iPad's native Notes app.)
    ...
    \item\label{Faraday's Paradox} Faraday's Paradox (Made by me, Grass, in my iPad's native Notes app.)

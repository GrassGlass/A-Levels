...
\begin{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|Sc|Sc|Sc|Sc|Sc|}
            ...
            \hline
            \hline
            \textbf{Analogue} & \textbf{in general} & \textbf{2} & \multicolumn{2}{Sc|}{\textbf{smallest division}}\\ 
            \hline
            ...
            \end{minipage}}\\
            \hline
            Thermometer & change in temperature & 2 & \multicolumn{2}{Sc|}{1 \(^\circ\)C}\\
            \hline
    ...
    \end{table}
    \item Always take the average of three measurements (and show the working for the averaging explicitly) wherever possible. 
    \item Uncertainty rules:
    \item After finishing calculations for a question, always check whether the number of s.f. or d.p. is correct.
    \item Percentage uncertainty of stopwatch,
    \[\frac{\Delta t}{t}=\frac{0.2}{\widebar{t}}\cdot 100\%=\rule{0.5cm}{0.05mm}\,\%\ (1\ s.f.),\]
    where \(\widebar{t}\) denotes the average time taken.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item Plot \(y\) against \(x\). Then, the vertical intercept is \(c\) and the gradient is \(m\). 
    \end{itemize}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{|Sc|Sc|}
            \hline
            Is there an anomalous point? & Phrasing\\
            \hline
            \textcolor{red}{\(\times\)} & 
            \begin{minipage}{0.7\textwidth-24.03719pt}
                There is no anomalous point as all plotted points follow the trend of the best fit line.
            \end{minipage}\\
            \hline
            \multirow{2}{*}[-2mm]{\textcolor{green!70!black}{\checkmark}} & 
            \begin{minipage}{0.7\textwidth-24.03719pt}
                There is one anomalous point as all plotted points follow the trend of the best fit line.
            \end{minipage}\\
            \cline{2-2}
            & 
            \begin{minipage}{0.7\textwidth-24.03719pt}
...
\begin{itemize}
    ...
    \item Examples of significant sources of error and the ways to remedy them.
    \begin{enumerate}
        \item[(a)(i)] (J1 P08) It is difficult to track the oscillating mass when the amplitude of the oscillations is small and the period is short. 
        \item[(ii)]
        ...
        \end{enumerate}
        \item[(c)(i)] (J1 P06) The values for current and voltage constantly fluctuate throughout the experiment. This introduces significant random error, which makes the value of \(c_2\) obtained less precise.
        \item[(ii)] Increase the mass of the oil added into the metal significantly. (So the measured values of \(t\) all increase in magnitude, reducing the effect of the random error\dots)
        \item[(d)(i)] (J1 P04) There is significant friction between the hooks and the thread. (this adds systematic error into the measured values of \(t\).)
        \item[(ii)] Use rollers instead of hooks, to minimise the friction experienced by the moving thread.
        \item[(e)(i)] (J1 P01) It is difficult to maintain protraction, and hence, hard to measure \(\theta\) precisely.
        \item[(ii)] Clamp the protractor using another retort stand.    
    \end{enumerate}
\end{itemize}

...
\begin{tikzpicture}
  ...
  \draw[<->] (-2.1*\t,\t/2) -- (-2.1*\t,\W-\t/2) node[midway] {\contour{white}{$l$}};
...
\begin{tikzpicture}
  ...
  \draw[<->] (-0.66*\W,0) --++ (0,\L) node[midway] {\contour{white}{$l$}};
...
\begin{tikzpicture}
  ...
  \begin{scope}[shift={(-1.8*\lx,0.18*\Ly)}]
    ...
    \draw[<->] (0,-2.1*\t) --++ (\lx,0) node[midway,fill=white,inner sep=0.8] {$l_x$}; %{\contour{white}{$l_x$}};
    \draw[<->] (-2.1*\t,0) --++ (0,\ly) node[midway,fill=white,inner sep=0.8] {$l_y$}; %{\contour{white}{$l_y$}};
  \end{scope}

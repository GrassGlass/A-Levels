...
\begin{tikzpicture}
  ...
  \draw[velocity] (M1)++(\w/2,\h/2) --++ (1.1*\v,0) node[left=2,above=0] {$\vb{u}_1$};
  \draw[velocity] (M2)++(-\w/2,\h/2) --++ (-0.9*\v,0) node[right=0,above=0] {$\vb{u}_2$};
...
\begin{tikzpicture}
  ...
  \coordinate (M1) at (-\d/2+\w/2,0);
  \coordinate (M2) at (\d/2-\w/2,0);
  \draw[ground] (-\L/2,0) rectangle++ (\L+0.15,-0.2);
  \draw[thick] (-\L/2,0) --++ (\L+0.15,0);
...
\begin{tikzpicture}
    ...
    \coordinate (M2) at (\x+\w/2+1.4,0);
    \draw[ground] (-1,0) rectangle++ (\L+2.5,-0.2);
    \draw[thick] (-1,0) --++ (\L+2.5,0);
    \draw[velocity] (M1)++(\w/2,\h/2) --++ (0.8,0) node[right=-1] {$\vb{v}_1$};
    \draw[velocity] (M2)++(\w/2,\h/2) --++ (2.55,0) node[right=-1] {$\vb{v}_2$};
    \draw[mass] (M1)++(-\w/2,0) rectangle++ (\w,\h) node[midway] {$m_1$};
    \draw[mass] (M2)++(-\w/2,0) rectangle++ (\w,\h) node[midway] {$m_2$};
...
\begin{tikzpicture}
  ...
  \draw[velocity] (M1)++(\w/2,0) --++ (1.1*\v,0) node[above=-1] {$\vb{u}_1$};
  \draw[velocity] (M2)++(0,\h/2) --++ (0,\v) node[right=-1] {$\vb{u}_2$};
  \draw[mass] (M1)++(-\w/2,-\h/2) rectangle++ (\w,\h) node[midway] {$m_1$};
  \draw[mass] (M2)++(-\h/2,-\w/2) rectangle++ (\h,\w) node[midway] {$m_2$};

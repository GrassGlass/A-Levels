...
\begin{enumerate}
    ...
    \item Between Scylla and Charybdis --- between a rock and a hard place / (choosing) the lesser of two evils.
    \begin{itemize}
        \item  The dichotomy between the many small and directly applicable models and the large, abstract supermodel cannot be explained away. Each must find his own way between Scylla and Charybdis. 
        \item I was between Scylla and Charybdis, for if I didn't take out another loan—and go deeper into debt—I could not pay off the debts I already owed.
        \item  He's truly between Scylla and Charybdis this time, so he had better get some good advice.
        \item During these years, America's economy steered a remarkable course between the Scylla of inflation and the Charybdis of recession.
    \end{itemize}
\end{enumerate}

...
\begin{stbox}{General Information}
    \begin{itemize}
        ...
        \begin{enumerate}
            ...
            \[x_{n+1}\coloneq\frac{a \lvert f(x_n) \rvert+x_n \lvert f(a) \rvert}{\lvert f(x_n) \rvert+\lvert f(a) \rvert}.\]
            \begin{itemize}
                ...
                \begin{table}[H]
                    ...
                    \begin{tabular}{|Sc|Sc|Sc|}
                        ...
                        \hline
                        Upwards \(\bigcap\) & \textcolor{blue}{underestimation} & \textcolor{red}{overestimation}\\
                        \hline
                        Downwards \(\bigcup\) & \textcolor{red}{overestimation} & \textcolor{blue}{underestimation}\\
                        \hline
                    \end{tabular}
            ...
            \end{itemize}
            \item The Newton-Raphson Method. For a function \(f\colon \mathbb{R}\to \mathbb{R}\) with a root \(\alpha\), the Newton-Raphson formula is
            ...
            \begin{itemize}
                ...
                \begin{enumerate}
                    ...
                    \item There is a point of inflection.
                \end{enumerate}
                \item Error: 
                \begin{table}[H]
                    \centering
                    \begin{tabular}{|Sc|Sc|Sc|}
                        ...
                        Concave/Gradient & Positive & Negative\\
                        \hline
                        Upwards \(\bigcap\) & \textcolor{red}{overestimation} & \textcolor{blue}{underestimation}\\
                        \hline
                        Downwards \(\bigcup\) & \textcolor{blue}{underestimation} & \textcolor{red}{overestimation}\\
                        \hline
                    \end{tabular}
...
\begin{GCSkills}{}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{../Diagrams/linear-interpolation.pdf}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.8\textwidth]{../Diagrams/newton's-method.pdf}

...
\end{note}
\begin{note}
    If the question asks for the approximation of a root to \(k\) significant figures/\(k\) decimal places, then our iterative process must be continued until two consecutive iterations agree up to \(k+2\) significant figures/\(k+2\) decimal places.
\end{note}
\begin{GCSkills}{}

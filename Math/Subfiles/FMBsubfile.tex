...
\begin{stbox}{}
  \begin{itemize}
    \item We cannot write ``a \(\frac{1-\alpha}{100}\) confidence interval''. The \(\frac{1-\alpha}{100}\) must always be expressed as a \emph{percentage}.
    ...
    Hence, by solving \(\Prob(-z_{1-\alpha/2}<Z<z_{1-\alpha/2})=1-\alpha\), we obtain a \((1-\alpha)100\%\) confidence interval

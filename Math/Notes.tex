...
\begin{stbox}{General Information}
  \begin{enumerate}
    ...
    \begin{enumerate}
      ...
      \begin{center}
        \includegraphics[scale=0.11]{../images/ComplexPerpendicularBisectorLocus}
      \end{center}
...
\begin{enumerate}
  \item Trapezium rule tikzpicture credit: \url{https://tex.stackexchange.com/a/110618}
  \item Simpson's rule tikzpicture credit: \url{https://tex.stackexchange.com/a/439119}
  \item Fig 15.2 \url{https://tikz.net/dynamics_oscillator/}
  \item Fig 17.1 \url{https://math.oxford.emory.edu/site/math117/normalApproxToBinomial/}
\end{enumerate}
